...
// Debounce Release (6:4) & debounce touch (3:0)
static unsigned char const DRDT = 0x5B;		// Formerly DTR

// configuration registers
static unsigned char const FGCDC = 0x5C;	// Formerly AFE1
static unsigned char const FGCDT = 0x5D;	// Formarly AFE2
